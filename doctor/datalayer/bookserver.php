...
if(count($errors)==0){
	...
	$sqladd = "INSERT INTO  doctor (Doctorname, email, Address, ContactNumber, password,categorey) VALUES ('$addname','$addEmail','$addAddress','$addContactNumber','$addPassword','$addcategory') ";
