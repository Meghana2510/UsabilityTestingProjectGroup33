...
<body >
		<center><div class="headerP" style="width: 15%;margin-top: 60px;color: white;background: #39ca74;text-align: center;border-radius: 10px 10px 5px 5px;border-bottom: none; border :1px solid #39ca74;padding: 10px;margin-left:-4p;align: center  ">
...
<form method="post" action="index.php"  class="infoP" style="position:absolute; left:400px; top:200px;margin-left:1px; margin-top:0px ;width: 40%;padding: 20px;border :3px solid #39ca74 ;background: white; border-radius: 10px 10px 10px 10px;">
...
<div class="contentP" style="font-size: 20px;font-weight: bold;">



	<label>ID: <?php if (isset($_SESSION['UserID'])){$UserID= $_SESSION['UserID'];echo $UserID;}?></label>
