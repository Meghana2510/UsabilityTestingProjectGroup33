...
<body>
	...
	<table class="table4">
	   ...
	   <h1 style="margin-left:37% ;margin-top:70px"   class="asd">Send Confirmation Email </h1><br><br>

    <center><form role="form" method="post" enctype="multipart/form-data" class="form1" style="width: 100%;margin-top:110px;margin-left: -10px;">
